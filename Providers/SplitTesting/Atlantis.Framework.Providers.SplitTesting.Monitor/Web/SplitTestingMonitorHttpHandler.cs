...
{
  public class SplitTestingMonitorHttpHandler : IHttpHandler
  {
    ...
    private void ResponseHtml(HttpContext context, XDocument monitorData, MonitorDataTypes dataType)
    {
      ...
      string resourcePath = "Atlantis.Framework.Providers.SplitTesting.Monitor.Resources." + dataType.ToString().ToLowerInvariant() + ".xslt";
