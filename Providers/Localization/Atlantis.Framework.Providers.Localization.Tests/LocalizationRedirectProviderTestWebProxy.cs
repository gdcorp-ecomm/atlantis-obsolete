...
{
  internal class LocalizationRedirectProviderTestWebProxy : ProviderBase, IProxyContext
  {
    public LocalizationRedirectProviderTestWebProxy(IProviderContainer container)
      : base(container)
    { }
