...
namespace Atlantis.Framework.HCC.Interface
{
  ...
  public class HCCIsPasswordValidResponse : IHCCResponseMessage
  {
    [DataMember(Name = "xml")]
    ...
    public HCCIsPasswordValidResponse(string responseMessage, string responseStatus, int responseStatusCode)
    {
