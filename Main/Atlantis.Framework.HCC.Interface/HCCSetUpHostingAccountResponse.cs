...
namespace Atlantis.Framework.HCC.Interface
{
  ...
  public class HCCSetUpHostingAccountResponse : IHCCResponseMessage
  {
    [DataMember(Name = "xml")]
    ...
    public HCCSetUpHostingAccountResponse(string responseMessage, string responseStatus, int responseStatusCode)
    {
