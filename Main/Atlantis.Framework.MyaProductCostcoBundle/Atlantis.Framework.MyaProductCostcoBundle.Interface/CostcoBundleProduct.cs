...
{
  public class CostcoBundleProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.CostcoBundle; }
    }
    ...
    public CostcoBundleProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
