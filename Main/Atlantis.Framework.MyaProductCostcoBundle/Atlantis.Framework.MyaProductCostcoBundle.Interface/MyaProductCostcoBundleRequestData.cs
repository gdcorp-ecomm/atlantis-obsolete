...
{
  public class MyaProductCostcoBundleRequestData : RequestData
  {
    #region Properties
    ...
    public MyaProductCostcoBundleRequestData(string shopperId
      , string sourceUrl
      , string orderId
      , string pathway
      , int pageCount
      ...
      : base(shopperId, sourceUrl, orderId, pathway, pageCount)
    {
      ...
      PagingInfo = new CostcoBundlePagingInfo();
    }
    ...
    {
      throw new NotImplementedException("GetCacheMD5 not implemented in MyaProductCostcoBundleRequestData");     
    }
  }
}
