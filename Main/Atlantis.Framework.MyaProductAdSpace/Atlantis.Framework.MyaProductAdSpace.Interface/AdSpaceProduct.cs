...
{
  public class AdSpaceProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.AdSpace; }
    }
    ...
    public AdSpaceProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
