...
{
  public class PhotoAlbumProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    public PhotoAlbumProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
