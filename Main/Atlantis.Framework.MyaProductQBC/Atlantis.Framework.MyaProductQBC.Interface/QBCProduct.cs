...
{
  public class QBCProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.QuickBlogCast; }
    }
    ...
    public QBCProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
