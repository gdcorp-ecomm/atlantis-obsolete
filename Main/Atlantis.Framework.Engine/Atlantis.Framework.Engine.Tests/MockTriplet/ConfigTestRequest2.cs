...
{
  public class ConfigTestRequest2 : IRequest
  {
    ...
    public IResponseData RequestHandler(RequestData oRequestData, ConfigElement oConfig)
    {
      ...
      {
        AtlantisException ex = new AtlantisException(oRequestData, "ConfigTestRequest1.RequestHandler", "Expected no config values.", string.Empty);
