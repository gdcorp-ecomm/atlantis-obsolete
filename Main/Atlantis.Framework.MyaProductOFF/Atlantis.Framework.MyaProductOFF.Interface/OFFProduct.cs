...
{
  public class OFFProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    public OFFProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
