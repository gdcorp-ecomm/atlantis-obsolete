...
{
  public class CalendarProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    public CalendarProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
