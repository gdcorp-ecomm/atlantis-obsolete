...
{
  public class MyaProductCalendarRequestData : RequestData
  {
    #region Properties
    ...
    public MyaProductCalendarRequestData(string shopperId
      , string sourceUrl
      , string orderId
      , string pathway
      , int pageCount
      ...
      : base(shopperId, sourceUrl, orderId, pathway, pageCount)
    {
      ...
      PagingInfo = new CalendarPagingInfo();
    }

    public override string GetCacheMD5()
    {
      throw new NotImplementedException("GetCacheMD5 not implemented in MyaProductCalendarRequestData");     
    }
  }
}
