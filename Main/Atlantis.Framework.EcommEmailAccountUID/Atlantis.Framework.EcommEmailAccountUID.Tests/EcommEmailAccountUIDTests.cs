...
{
  [TestClass]
  public class EcommEmailAccountUIDTests
  {
    [TestMethod]
    public void TestMethod1()
    {
      EcommEmailAccountUIDRequestData request =
new EcommEmailAccountUIDRequestData("75866", string.Empty, "253880", string.Empty, 0);
