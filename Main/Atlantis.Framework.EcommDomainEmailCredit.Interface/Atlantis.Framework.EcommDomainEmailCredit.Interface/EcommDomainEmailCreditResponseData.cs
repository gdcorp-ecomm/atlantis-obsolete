...
namespace Atlantis.Framework.EcommDomainEmailCredit.Interface
{
  public class EcommDomainEmailCreditResponseData : IResponseData
  {
    ...
    public EcommDomainEmailCreditResponseData(List<DomainResults> results)
    {
      _domainResults = results;
      _success = true;
    }

    public EcommDomainEmailCreditResponseData(AtlantisException exAtlantis)
    {
      _exception = exAtlantis;
    }

    public EcommDomainEmailCreditResponseData(RequestData oRequestData, Exception ex)
    {
