...
{
  public class QSCProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    public int? PaymentProfileShopperProfileId
    {
      get
      {
        if (_paymentProfileShopperProfileId == null)
        {
          ...
          if (IsPropertyInDictionary("mya_getActiveUnifiedListHostingQSC_sp"))
          {
    ...
    public QSCProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
