...
{
  public class SiteAnalyticsProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.SiteAnalytics; }
    }
    ...
    public SiteAnalyticsProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
