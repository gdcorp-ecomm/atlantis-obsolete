...
{
  public class MyaProductSiteAnalyticsRequestData : RequestData
  {
    #region Properties
    ...
    public MyaProductSiteAnalyticsRequestData(string shopperId
      , string sourceUrl
      , string orderId
      , string pathway
      , int pageCount
      ...
      : base(shopperId, sourceUrl, orderId, pathway, pageCount)
    {
      ...
      PagingInfo = new SiteAnalyticsPagingInfo();
    }

    public override string GetCacheMD5()
    {
      throw new NotImplementedException("GetCacheMD5 not implemented in MyaProductSiteAnalyticsRequestData");     
    }
  }
}
