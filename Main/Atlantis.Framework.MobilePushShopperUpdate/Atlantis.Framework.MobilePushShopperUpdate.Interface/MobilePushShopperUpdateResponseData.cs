...
{
  public class MobilePushShopperUpdateResponseData : IResponseData
  {
    ...
    public MobilePushShopperUpdateResponseData(MobilePushShopperUpdateRequestData requestData, string responseXml)
    {
      Xml = responseXml;
    ...
    public MobilePushShopperUpdateResponseData(MobilePushShopperUpdateRequestData requestData, Exception ex)
    {
      Xml = string.Empty;
      AtlantisException = new AtlantisException(requestData,
                                                MethodBase.GetCurrentMethod().DeclaringType.FullName,
