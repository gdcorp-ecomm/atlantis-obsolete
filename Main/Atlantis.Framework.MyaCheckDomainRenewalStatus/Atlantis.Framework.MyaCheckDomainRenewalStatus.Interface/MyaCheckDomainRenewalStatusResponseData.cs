...
{
  public class MyaCheckDomainRenewalStatusResponseData : IResponseData
  {
    ...
    public MyaCheckDomainRenewalStatusResponseData(string responseXML, RequestData requestData)
    {
    ...
    public MyaCheckDomainRenewalStatusResponseData(string responseXML, RequestData requestData, AtlantisException exAtlantis)
      : this(responseXML, requestData)
    {
      ...
      if (!string.IsNullOrEmpty(_responseXml))
      {
        ...
        catch (Exception ex)
        {
          _exception = new AtlantisException(_requestData,
                               "MyaCheckDomainRenewalStatusResponseData ParseResponseXML",
