...
{
  public class EEMProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    protected override string AccountExpirationDateKey { get { return "expiration_date"; } }
    ...
    protected override string ProductIdKey { get { return "catalog_productUnifiedProductID"; } }
    ...
    {
      get { return MyaProductType.ExpressEmailMarketing; }
    }
    ...
    public int? PaymentProfileShopperProfileId
    {
      get
      {
        if (_paymentProfileShopperProfileId == null)
        {
          ...
          if (IsPropertyInDictionary("mya_GetActiveUnifiedList_sp"))
          {
    ...
    public EEMProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
