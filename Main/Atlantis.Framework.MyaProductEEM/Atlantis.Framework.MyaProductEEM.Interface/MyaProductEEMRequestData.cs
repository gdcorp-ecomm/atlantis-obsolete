...
{
  public class MyaProductEEMRequestData : RequestData
  {
    #region Properties
    public int? OverrideEEMCustomerSummaryRequestType { get; set; }
    ...
    public MyaProductEEMRequestData(string shopperId
      , string sourceUrl
      , string orderId
      , string pathway
      , int pageCount
      ...
      : base(shopperId, sourceUrl, orderId, pathway, pageCount)
    {
      ...
      PagingInfo = new EEMPagingInfo();
    }

    public override string GetCacheMD5()
    {
      throw new NotImplementedException("GetCacheMD5 not implemented in MyaProductEEMRequestData");     
    }
  }
}
