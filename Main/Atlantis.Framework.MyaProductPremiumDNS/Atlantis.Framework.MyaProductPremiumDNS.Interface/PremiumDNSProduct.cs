...
{
  public class PremiumDNSProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.PremiumDNS; }
    }
    ...
    public PremiumDNSProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
