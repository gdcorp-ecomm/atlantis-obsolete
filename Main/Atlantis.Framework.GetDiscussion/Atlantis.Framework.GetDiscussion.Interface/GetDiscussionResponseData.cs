...
{
  public class GetDiscussionResponseData : IResponseData
  {
    ...
    public GetDiscussionResponseData(long threadID,
       int forumId,
       string title,
       int creatorId,
       string creator,
    ...
    public GetDiscussionResponseData(AtlantisException ex)
    {
      _ex = ex;
    }

    public GetDiscussionResponseData(RequestData oRequestData, Exception ex)
    {
      _ex = new AtlantisException(oRequestData, "GetDiscussionResponseData", ex.Message, oRequestData.ToXML());          
    }
