...
{
  public class MyaProductEasyDBRequestData : RequestData
  {
    #region Properties
    ...
    public MyaProductEasyDBRequestData(string shopperId
      , string sourceUrl
      , string orderId
      , string pathway
      , int pageCount
      ...
      : base(shopperId, sourceUrl, orderId, pathway, pageCount)
    {
      ...
      PagingInfo = new EasyDBPagingInfo();
    }

    public override string GetCacheMD5()
    {
      throw new NotImplementedException("GetCacheMD5 not implemented in MyaProductEasyDBRequestData");     
    }
  }
}
