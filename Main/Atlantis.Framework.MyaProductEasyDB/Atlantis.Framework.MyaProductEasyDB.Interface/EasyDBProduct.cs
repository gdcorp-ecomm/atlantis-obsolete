...
{
  public class EasyDBProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.EasyDB; }
    }
    ...
    public EasyDBProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
