...
{
  public class SafeSiteProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    public SafeSiteProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
