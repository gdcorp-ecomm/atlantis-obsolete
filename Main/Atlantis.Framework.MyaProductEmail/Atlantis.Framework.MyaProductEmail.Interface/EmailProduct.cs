...
{
  public class EmailProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.Email; }
    }
    ...
    public EmailProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary) : base(privateLabelId, propertiesDictionary)
    {
    }
  }
}
