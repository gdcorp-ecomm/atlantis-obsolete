...
namespace Atlantis.Framework.Tests
{
  ...
  public class DocumentTests
  {
    ...
    {
      DocumentRequestData request = new DocumentRequestData(
        string.Empty, string.Empty, string.Empty, string.Empty, 0,
        1, "UTOS_ver2");
      request.FullDocument = false;
      request.MarginWidth = 0;
      DocumentResponseData response = (DocumentResponseData)DataCache.DataCache.GetProcessRequest(request, EngineRequests.DocumentGet);
