...
{
  /// <summary>
  /// Summary description for ShopperPriceTypeTests
  /// </summary>
  [TestClass]
  public class ShopperPriceTypeTests
  {
    ...
    public void ShopperPriceTypeBasic()
    {
      ...
      ShopperPriceTypeResponseData response = (ShopperPriceTypeResponseData)DataCache.DataCache.GetProcessRequest(
        request, EngineRequests.ShopperPriceType);
      Console.WriteLine(response.PriceType);
    }
  }
}
