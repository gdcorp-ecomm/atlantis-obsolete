...
namespace Atlantis.Framework.EventGetServicesList.Impl.EventDataWS {
    using System;
    ...
    public partial class SupportEventData : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SupportEventData() {
            this.Url = global::Atlantis.Framework.EventGetServicesList.Impl.Properties.Settings.Default.Atlantis_Framework_EventGetServicesList_Impl_EventDataWS_SupportEventData;
        ...
        public string SearchEvents(string clientName, System.DateTime startDate, System.DateTime endDate) {
        ...
        public string GetAllActiveEvents(string clientName) {
