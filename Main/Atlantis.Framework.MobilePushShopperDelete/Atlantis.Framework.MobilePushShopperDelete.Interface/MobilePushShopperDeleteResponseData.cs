...
{
  public class MobilePushShopperDeleteResponseData : IResponseData
  {
    ...
    public MobilePushShopperDeleteResponseData(MobilePushShopperDeleteRequestData requestData, string responseXml)
    {
      Xml = responseXml;
    ...
    public MobilePushShopperDeleteResponseData(MobilePushShopperDeleteRequestData requestData, Exception ex)
    {
      Xml = string.Empty;
      AtlantisException = new AtlantisException(requestData,
                                                MethodBase.GetCurrentMethod().DeclaringType.FullName,
