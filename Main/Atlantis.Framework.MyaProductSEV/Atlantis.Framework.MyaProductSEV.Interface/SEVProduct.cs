...
{
  public class SEVProduct : MyaProductBase, IMyaProductAutoRenewable, IMyaProductPaymentProfile
  {
    ...
    {
      get { return MyaProductType.SearchEngineVisibility; }
    }
    ...
    public SEVProduct(int privateLabelId, IDictionary<string, object> propertiesDictionary)
