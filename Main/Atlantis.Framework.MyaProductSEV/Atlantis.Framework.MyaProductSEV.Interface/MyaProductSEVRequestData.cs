...
{
  public class MyaProductSEVRequestData : RequestData
  {
    #region Properties
    ...
    public MyaProductSEVRequestData(string shopperId
      , string sourceUrl
      , string orderId
      , string pathway
      , int pageCount
      ...
      : base(shopperId, sourceUrl, orderId, pathway, pageCount)
    {
      ...
      PagingInfo = new SEVPagingInfo();
    }

    public override string GetCacheMD5()
    {
      throw new NotImplementedException("GetCacheMD5 not implemented in MyaProductSEVRequestData");     
    }
  }
}
