...
{
  public class OutreachDetailActivityRequestData : RequestData
  {
    ...
    public OutreachDetailActivityRequestData(string shopperId,
                                  string sourceUrl,
                                  string orderIo,
                                  string pathway,
                                  int pageCount,
    ...
    {
      throw new NotImplementedException("GetCacheMD5 not implemented in OutreachDetailActivityRequestData");     
    }
