...
namespace Atlantis.Framework.Entity.Interface.SelfTracking
{
    public static class SelfTrackingEntitiesContextExtensions
    {
        ...
        private static void ApplyChangesToIndependentAssociation(ObjectContext context, IObjectWithChangeTracker changedEntity, ObjectStateEntry entry, NavigationProperty navProp, IRelatedEnd relatedEnd, RelationshipSet allRelationships)
        {
        ...
        /// 
        /// </summary>
        /// <param name="keyMemberName"></param>
        ...
        /// <param name="propertyPathToType"></param>
        /// <param name="originalValueSource"></param>
        /// <param name="complexOriginalValueRecord"></param>
        ...
        /// </summary>
        /// <param name="entry"></param>
        /// <param name="navigationPropertyIdentity"></param>
        /// <returns></returns>
