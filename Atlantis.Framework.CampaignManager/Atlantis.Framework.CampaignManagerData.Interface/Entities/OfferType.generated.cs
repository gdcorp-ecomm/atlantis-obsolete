...
namespace Atlantis.Framework.CampaignManagerData.Interface.Entities
{
    ...
    public partial class OfferType:  IAtlantisEntity, IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public byte OfferTypeID
        {
            ...
            set
            {
                if (_offerTypeID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'OfferTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _offerTypeID = value;
        ...
        private void FixupCampaigns(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.OfferType, this))
                    {
                        item.OfferType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
