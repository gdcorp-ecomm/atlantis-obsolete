...
namespace Atlantis.Framework.CampaignManagerData.Interface.Entities
{
    ...
    public partial class ProductGroup:  IAtlantisEntity, IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ProductGroupCode
        {
            ...
            set
            {
                if (_productGroupCode != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ProductGroupCode' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        public string ProductGroupDescription
        {
            ...
            set
            {
                if (_productGroupDescription != value)
                {
                    _productGroupDescription = value;
                    OnPropertyChanged("ProductGroupDescription");
                }
            }
        }
