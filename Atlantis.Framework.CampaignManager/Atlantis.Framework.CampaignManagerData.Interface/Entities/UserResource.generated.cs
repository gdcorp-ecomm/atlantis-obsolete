...
namespace Atlantis.Framework.CampaignManagerData.Interface.Entities
{
    ...
    public partial class UserResource:  IAtlantisEntity, IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int UserResourceID
        {
            ...
            set
            {
                if (_userResourceID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'UserResourceID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupCampaignUserResourceMaps(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.UserResource, this))
                    {
                        item.UserResource = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
