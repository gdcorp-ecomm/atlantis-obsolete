...
namespace Atlantis.Framework.CampaignManagerData.Interface.Entities
{
    ...
    public partial class Placement:  IAtlantisEntity, IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int PlacementID
        {
            ...
            set
            {
                if (_placementID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'PlacementID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _placementID = value;
        ...
        public string PlacementCode
        {
            ...
            set
            {
                if (_placementCode != value)
                {
                    _placementCode = value;
                    OnPropertyChanged("PlacementCode");
                }
            }
        }
        ...
        [DataMember]
        public string SchematicXML
        {
            get { return _schematicXML; }
            set
            {
                if (_schematicXML != value)
                {
                    _schematicXML = value;
                    OnPropertyChanged("SchematicXML");
                }
            }
        }
        private string _schematicXML;
        ...
        private void FixupDeliveryChannel(DeliveryChannel previousValue)
        {
            ...
            if (previousValue != null && previousValue.Placements.Contains(this))
            {
            ...
            {
                if (!DeliveryChannel.Placements.Contains(this))
                {
                    DeliveryChannel.Placements.Add(this);
                }
        ...
        private void FixupMessageBlocks(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Placement, this))
                    {
                        item.Placement = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
