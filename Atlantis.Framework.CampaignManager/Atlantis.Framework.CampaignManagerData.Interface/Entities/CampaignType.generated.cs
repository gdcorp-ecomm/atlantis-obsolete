...
namespace Atlantis.Framework.CampaignManagerData.Interface.Entities
{
    ...
    public partial class CampaignType:  IAtlantisEntity, IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public byte CampaignTypeID
        {
            ...
            set
            {
                if (_campaignTypeID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'CampaignTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupCampaigns(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.CampaignType, this))
                    {
                        item.CampaignType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
