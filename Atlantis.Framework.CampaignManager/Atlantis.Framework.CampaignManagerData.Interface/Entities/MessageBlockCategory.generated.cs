...
namespace Atlantis.Framework.CampaignManagerData.Interface.Entities
{
    ...
    public partial class MessageBlockCategory:  IAtlantisEntity, IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public short MessageBlockCategoryID
        {
            ...
            set
            {
                if (_messageBlockCategoryID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'MessageBlockCategoryID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        [DataMember]
        public string MessageBlockCategoryDescription
        {
            get { return _messageBlockCategoryDescription; }
            set
            {
                if (_messageBlockCategoryDescription != value)
                {
                    _messageBlockCategoryDescription = value;
                    OnPropertyChanged("MessageBlockCategoryDescription");
                }
            }
        }
        private string _messageBlockCategoryDescription;
        ...
        private void FixupMessageBlocks(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    item.MessageBlockCategory = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.MessageBlockCategory, this))
                    {
                        item.MessageBlockCategory = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
