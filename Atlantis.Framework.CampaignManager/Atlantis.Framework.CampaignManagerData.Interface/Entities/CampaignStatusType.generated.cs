...
namespace Atlantis.Framework.CampaignManagerData.Interface.Entities
{
    ...
    public partial class CampaignStatusType:  IAtlantisEntity, IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int CampaignStatusTypeID
        {
            ...
            set
            {
                if (_campaignStatusTypeID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'CampaignStatusTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupCampaigns(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.CampaignStatusType, this))
                    {
                        item.CampaignStatusType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
